...
exports.structuredToCoords = function (structured) {
  return structured.map(function (elem) {
    var poly = [elem.hull.toArray()];
    var holes = elem.holes.map(function (hole) {
      return hole.toArray();
    })
    return poly.concat(holes);
  });
}
